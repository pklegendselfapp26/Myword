...
try:
    # ==========================================
    # ALL YOUR APP IMPORTS AND CODE GO IN HERE
    # ==========================================
    import json
    import os
    import time
    ...
    class SettingsScreen(MDScreen):
        ...
        def export_csv(self):
            ...
            try:
                ...
                MDApp.get_running_app().show_dialog("Error", "Storage permission required. File saved to internal data.")
...
# ==========================================
# IF ANYTHING FAILS, THIS WILL SHOW ON SCREEN
# ==========================================
except Exception:
    error_message = traceback.format_exc()
    
    # We load standard Kivy (not KivyMD) to guarantee it draws on the screen safely
    ...
    class CrashApp(App):
        def build(self):
            # Turn the screen red so you know it caught the error
